      ...
      complete_invoice_html = f"""
            ...
            <head>
                <style>
                    ...
                    .signature-box {{ border: 1px solid #777; padding: 18px 15px; border-radius: 4px; margin-top: 4px; background: #fff; }}
                    ...
                    <div class="copy-section">
                        ...
                        <div class="signature-box">
                            <div class="signatures">
                                ...
                                <span style="margin-right: 80px;">SMT Signature</span>
                            </div>
                        </div>
                    </div>
            ...
            """
      components.html(complete_invoice_html, height=850, scrolling=True)
          ...
          with col_act1:
            if st.button("🖨️ Generate Reprint Preview"):
              ...
              reprint_html = f"""
                            ...
                            """
              components.html(reprint_html, height=550, scrolling=True)
